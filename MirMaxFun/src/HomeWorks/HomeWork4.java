...
public class HomeWork4 {
    ...
    } // Я НЕ СМОГ ЭТО РЕШИТЬ САМ, У МЕНЯ БЫЛО МНОГО ПОПЫТОК, НО СПУСТЯ 3 ЧАСА ЗАШЕЛ В ГУГЛ ЧТОБЫ НАЙТИ РЕШЕНИЕ, Я ЗНАЮ ЧТО НЕКОТОРЫЕ МЕТОДЫ МЫ ЕЩЕ НЕ ИЗУЧАЛИ (ПРОСТИТЕ)
