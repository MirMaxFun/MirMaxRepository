    ...
    */
    ...
    public static class Person {
        ...
        public String announce() {
            //String ann = "Person " + name + " имеет характеристики: " + health + " здоровья и " + protection + " защиты";
            return "Person " + name + " имеет характеристики: " + health + " здоровья и " + protection + " защиты";
        }
//        Метод - void takeDamage(Integer damage) {} - вычитает урон из здоровья персонажа по
//        формуле health - (damage - protection)
//        Урон не может быть отрицательным (вызывать исключение Exception)
//        Здоровье не может стать отрицательным
//        Когда здоровье персонажа опускается до 0, выкидывается исключение PersonDead
        public void takeDamage(Integer damage) throws Exception {
            ...
            int damage2 = damage - protection;
            health = health - damage2;
            try {
                if (health < 0) throw new PersonDead("Person has dead");
            } catch (PersonDead e) {
                System.err.println("");
            }
        }
        public Integer facePunch() throws Exception {
            int damage=1;
            takeDamage(damage);
            return damage;
        }
    ...
    */
    ...
    public static class Mage extends Person{
        ...
        protected Mage(String name, Integer protection, Integer health) {
            super(name, protection, health);
        }
...
//            String ann = "Mage " + name + " имеет характеристики: " + health + " здоровья и " + protection + " защиты";
        ...
        public void  takeDamage(Integer damage) throws Exception {
            ...
            int health2 = health / 100;
            int health3 = health2 * 10;
            int damage2 = damage - protection;
            int damage3 = damage2 - health3;
        ...
        Integer fireBall() throws Exception {
            int damage=45;
            takeDamage(damage);
            return damage;
        }
...
//    Метод - Integer shootBow() - стрельба из лука наносит 40 + health % 10 урона
    ...
    public static class Archer extends Person{
        ...
        protected Archer(String name, Integer protection, Integer health) {
            super(name, protection, health);
        }
        ...
        @Override
        public String announce() {
//            String ann = "Archer " + name + " имеет характеристики: " + health + " здоровья и " + protection + " защиты";
            return "Archer " + name + " имеет характеристики: " + health + " здоровья и " + protection + " защиты";
        }
        ...
        Integer shootBow() throws Exception {
            int health2 = health % 10;
            takeDamage(40 +  health2);
            int damage = 40 + health2;
            return damage;
        }
